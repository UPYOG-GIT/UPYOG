...
public class GatewayService {
	 ...
	 * <p>
	 * The TXNID key can be anything, as this is gateway specific, * ex., txnid,
	 * vpc_txnid etc, check all payment gateway specific keys for txnid and returns
	 * txnid
	 *
	...
	/**
	 * Returns the redirectURI from the requested gateway if exists else throws
	 * CustomException
	 *
...
//		log.info("GATEWAY_MAP: " + GATEWAY_MAP.toString());
//		log.info("" + GATEWAY_MAP.containsKey(gateway));
//		log.info("" + GATEWAY_MAP.get(gateway).isActive());
