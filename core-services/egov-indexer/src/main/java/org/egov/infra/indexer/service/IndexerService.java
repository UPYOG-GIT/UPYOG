...
public class IndexerService {
	...
	public void indexProccessor(Index index, Mapping.ConfigKeyEnum configkey, String kafkaJson, boolean isBulk) throws Exception {
		...
		/*
		 * if(index.getName().contains("collection") ||
		 * index.getName().contains("payment") ||
		 * configkey.equals(Mapping.ConfigKeyEnum.LEGACYINDEX)) { // this is already
		 * sent } else { validateAndIndex(jsonToBeIndexed, url.toString(), index); }
		 */
