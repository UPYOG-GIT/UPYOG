...
var AddtionalDetails = function AddtionalDetails(props) {
  ...
  var appState = reactRedux.useSelector(function (state) {
    return state;
  })["common"];
  var _useTranslation = reactI18next.useTranslation(),
    t = _useTranslation.t;
  ...
  var updateComplaint = React.useCallback(function (complaintDetails) {
    try {
...
var ReopenComplaint = function ReopenComplaint(_ref) {
  ...
  return /*#__PURE__*/React__default.createElement(reactRouterDom.Switch, null, /*#__PURE__*/React__default.createElement(reactRouterDom.Route, {
    ...
    component: function component() {
      return /*#__PURE__*/React__default.createElement(ReasonPage, {
        match: match,
        complaintDetails: complaintDetails
      });
    }
    ...
    component: function component() {
      return /*#__PURE__*/React__default.createElement(UploadPhoto, {
        match: match,
        skip: true,
        complaintDetails: complaintDetails
      });
    ...
    component: function component() {
      return /*#__PURE__*/React__default.createElement(AddtionalDetails, {
        match: match,
    ...
    component: function component() {
      return /*#__PURE__*/React__default.createElement(Response, {
        match: match
      });
    }
  }));
...
var CreateComplaint = function CreateComplaint() {
  ...
  var config$1 = React.useMemo(function () {
  ...
  return /*#__PURE__*/React__default.createElement(reactRouterDom.Switch, null, Object.keys(config$1.routes).map(function (route, index) {
...
var ComplaintsList = function ComplaintsList(props) {
  ...
  return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(digitUiReactComponents.Header, null, t(LOCALE.MY_COMPLAINTS)), complaintsList);
};
...
var Resolved = function Resolved(_ref) {
  ...
  if (action === "RESOLVE") {
    ...
    return /*#__PURE__*/React__default.createElement(digitUiReactComponents.CheckPoint, {
      isCompleted: isCompleted,
      label: t("CS_COMMON_COMPLAINT_RESOLVED"),
      customChild: /*#__PURE__*/React__default.createElement("div", null, _actions, customChild)
    });
  }
};
...
var Rejected = function Rejected(_ref) {
  ...
  if (action === "REJECTED") {
    ...
    return /*#__PURE__*/React__default.createElement(digitUiReactComponents.CheckPoint, {
      isCompleted: isCompleted,
      label: t("CS_COMMON_COMPLAINT_REJECTED"),
      customChild: /*#__PURE__*/React__default.createElement("div", null, _actions)
    });
  }
};
...
var TimeLine = function TimeLine(_ref2) {
  ...
  var totalTimelineLength = React.useMemo(function () {
  ...
  var getCommentsInCustomChildComponent = function getCommentsInCustomChildComponent(_ref3) {
    ...
    return /*#__PURE__*/React__default.createElement(React.Fragment, null, comment ? /*#__PURE__*/React__default.createElement("div", null, comment === null || comment === void 0 ? void 0 : comment.map(function (e) {
    ...
    })) : null, (thumbnailsToShow === null || thumbnailsToShow === void 0 ? void 0 : (_thumbnailsToShow$thu2 = thumbnailsToShow.thumbs) === null || _thumbnailsToShow$thu2 === void 0 ? void 0 : _thumbnailsToShow$thu2.length) > 0 ? /*#__PURE__*/React__default.createElement("div", {
      className: "TLComments"
  ...
  return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(digitUiReactComponents.CardSubHeader, null, t(LOCALIZATION_KEY.CS_COMPLAINT_DETAILS + "_COMPLAINT_TIMELINE")), timeline && totalTimelineLength > 0 ? /*#__PURE__*/React__default.createElement(digitUiReactComponents.ConnectingCheckPoints, null, timeline.map(function (_ref6, index, array) {
...
var App = function App() {
  ...
  return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, !location.pathname.includes("/response") && /*#__PURE__*/React__default.createElement(digitUiReactComponents.BackButton, null, t("CS_COMMON_BACK")), /*#__PURE__*/React__default.createElement(reactRouterDom.Switch, null, /*#__PURE__*/React__default.createElement(digitUiReactComponents.PrivateRoute, {
    ...
    path: path + "/reopen",
    component: function component() {
      return /*#__PURE__*/React__default.createElement(ReopenComplaint, {
...
var Complaint$1 = function Complaint() {
  ...
  var location = reactRouterDom.useLocation().pathname;
  ...
  return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement("div", {
    ...
    path: match.url + Employee.CreateComplaint,
    component: function component() {
      return /*#__PURE__*/React__default.createElement(CreateComplaint, {
        parentUrl: match.url
      });
    }
  }), /*#__PURE__*/React__default.createElement(reactRouterDom.Route, {
    path: match.url + Employee.ComplaintDetails + ":id*",
    component: function component() {
      return /*#__PURE__*/React__default.createElement(ComplaintDetails, null);
    }
  }), /*#__PURE__*/React__default.createElement(reactRouterDom.Route, {
    path: match.url + Employee.Inbox,
    component: Inbox
...
var ComplaintDetails = function ComplaintDetails(props) {
  ...
  var getTimelineCaptions = function getTimelineCaptions(checkpoint, index, arr) {
    ...
    if (checkpoint.status === "PENDINGFORASSIGNMENT" && complaintDetails !== null && complaintDetails !== void 0 && complaintDetails.audit) {
      if (isFirstPendingForAssignment) {
        ...
        return /*#__PURE__*/React__default.createElement(React.Fragment, null, checkpoint !== null && checkpoint !== void 0 && checkpoint.wfComment ? /*#__PURE__*/React__default.createElement("div", null, checkpoint === null || checkpoint === void 0 ? void 0 : (_checkpoint$wfComment = checkpoint.wfComment) === null || _checkpoint$wfComment === void 0 ? void 0 : _checkpoint$wfComment.map(function (e) {
          return /*#__PURE__*/React__default.createElement("div", {
            className: "TLComments"
          }, /*#__PURE__*/React__default.createElement("h3", null, t("WF_COMMON_COMMENTS")), /*#__PURE__*/React__default.createElement("p", null, e));
        })) : null, checkpoint.status !== "COMPLAINT_FILED" && (thumbnailsToShow === null || thumbnailsToShow === void 0 ? void 0 : (_thumbnailsToShow$thu2 = thumbnailsToShow.thumbs) === null || _thumbnailsToShow$thu2 === void 0 ? void 0 : _thumbnailsToShow$thu2.length) > 0 ? /*#__PURE__*/React__default.createElement("div", {
          className: "TLComments"
        }, /*#__PURE__*/React__default.createElement("h3", null, t("CS_COMMON_ATTACHMENTS")), /*#__PURE__*/React__default.createElement(digitUiReactComponents.DisplayPhotos, {
          srcs: thumbnailsToShow.thumbs,
          onClick: function onClick(src, index) {
        ...
        })) : null, _caption !== null && _caption !== void 0 && _caption.date ? /*#__PURE__*/React__default.createElement(TLCaption$1, {
          data: _caption
        }) : null);
      }
    }
    ...
    })) : null, checkpoint.status !== "COMPLAINT_FILED" && (thumbnailsToShow === null || thumbnailsToShow === void 0 ? void 0 : (_thumbnailsToShow$thu3 = thumbnailsToShow.thumbs) === null || _thumbnailsToShow$thu3 === void 0 ? void 0 : _thumbnailsToShow$thu3.length) > 0 ? /*#__PURE__*/React__default.createElement("div", {
      className: "TLComments"
    }, /*#__PURE__*/React__default.createElement("h3", null, t("CS_COMMON_ATTACHMENTS")), /*#__PURE__*/React__default.createElement(digitUiReactComponents.DisplayPhotos, {
      srcs: thumbnailsToShow.thumbs,
      onClick: function onClick(src, index) {
  ...
  return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(digitUiReactComponents.Card, null, /*#__PURE__*/React__default.createElement(digitUiReactComponents.CardSubHeader, null, t("CS_HEADER_COMPLAINT_SUMMARY")), /*#__PURE__*/React__default.createElement(digitUiReactComponents.CardLabel, null, t("CS_COMPLAINT_DETAILS_COMPLAINT_DETAILS")), isLoading ? /*#__PURE__*/React__default.createElement(digitUiReactComponents.Loader, null) : /*#__PURE__*/React__default.createElement(digitUiReactComponents.StatusTable, null, complaintDetails && Object.keys(complaintDetails === null || complaintDetails === void 0 ? void 0 : complaintDetails.details).map(function (k, i, arr) {
    return /*#__PURE__*/React__default.createElement(digitUiReactComponents.Row, {
      key: k,
      label: t(k),
    ...
    onClose: closeToast
  }), !(workflowDetails !== null && workflowDetails !== void 0 && workflowDetails.isLoading) && (workflowDetails === null || workflowDetails === void 0 ? void 0 : (_workflowDetails$data14 = workflowDetails.data) === null || _workflowDetails$data14 === void 0 ? void 0 : (_workflowDetails$data15 = _workflowDetails$data14.nextActions) === null || _workflowDetails$data15 === void 0 ? void 0 : _workflowDetails$data15.length) > 0 && /*#__PURE__*/React__default.createElement(digitUiReactComponents.ActionBar, null, displayMenu && workflowDetails !== null && workflowDetails !== void 0 && (_workflowDetails$data16 = workflowDetails.data) !== null && _workflowDetails$data16 !== void 0 && _workflowDetails$data16.nextActions ? /*#__PURE__*/React__default.createElement(digitUiReactComponents.Menu, {
...
var CreateComplaint$1 = function CreateComplaint(_ref) {
  ...
  var _useState5 = React.useState(getCities()[0] ? getCities()[0] : null),
...
var Status = function Status(_ref) {
  ...
  }, t("ES_PGR_FILTER_STATUS")), complaintsWithCount.length === 0 && /*#__PURE__*/React__default.createElement(digitUiReactComponents.Loader, null), complaintsWithCount.map(function (option, index) {
...
var Filter = function Filter(props) {
  ...
  var assignedToOptions = React.useMemo(function () {
    return [{
      code: "ASSIGNED_TO_ME",
  ...
  var _useState = React.useState(isAssignedToMe ? assignedToOptions[0] : assignedToOptions[1]),
  ...
  var _useState3 = React.useState(null),
    selectedLocality = _useState3[0],
    setSelectedLocality = _useState3[1];
  var _useState4 = React.useState((searchParams === null || searchParams === void 0 ? void 0 : (_searchParams$filters6 = searchParams.filters) === null || _searchParams$filters6 === void 0 ? void 0 : _searchParams$filters6.pgrfilters) || {
      serviceCode: [],
      locality: [],
      applicationStatus: []
    }),
  ...
  var _useState5 = React.useState((searchParams === null || searchParams === void 0 ? void 0 : (_searchParams$filters7 = searchParams.filters) === null || _searchParams$filters7 === void 0 ? void 0 : _searchParams$filters7.wfFilters) || {
      assignee: [{
        code: uuid
      }]
    }),
...
var SearchComplaint = function SearchComplaint(_ref) {
  ...
  var _useState = React.useState((searchParams === null || searchParams === void 0 ? void 0 : (_searchParams$search = searchParams.search) === null || _searchParams$search === void 0 ? void 0 : _searchParams$search.serviceRequestId) || ""),
    complaintNo = _useState[0],
    setComplaintNo = _useState[1];
  var _useState2 = React.useState((searchParams === null || searchParams === void 0 ? void 0 : (_searchParams$search2 = searchParams.search) === null || _searchParams$search2 === void 0 ? void 0 : _searchParams$search2.mobileNumber) || ""),
...
var ComplaintCard = function ComplaintCard(_ref) {
  ...
  var _useState3 = React.useState(Digit.inboxFilterCount || 1),
