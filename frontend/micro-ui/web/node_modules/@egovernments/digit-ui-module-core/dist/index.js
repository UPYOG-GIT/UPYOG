...
var SelectOtp = function SelectOtp(_ref) {
  ...
  return /*#__PURE__*/React__default.createElement(digitUiReactComponents.FormStep, {
    ...
    onChange: onOtpChange,
    value: otp
  }), timeLeft > 0 ? /*#__PURE__*/React__default.createElement(digitUiReactComponents.CardText, null, t("RESEND ANOTHER OTP IN ") + " " + timeLeft + " " + t("SECONDS")) : /*#__PURE__*/React__default.createElement("p", {
    className: "card-text-button",
    onClick: handleResendOtp
  }, t("RESEND OTP")), !error && /*#__PURE__*/React__default.createElement(digitUiReactComponents.CardLabelError, null, t("INVALID OTP")));
};
...
var Login$1 = function Login(_ref) {
  ...
  var history = reactRouterDom.useHistory();
  var sourceUrl = "https://s3.ap-south-1.amazonaws.com/egov-qa-assets";
  var pdfUrl = "https://pg-egov-assets.s3.ap-south-1.amazonaws.com/Upyog+Code+and+Copyright+License_v1.pdf";
  React.useEffect(function () {
  ...
  }, "Copyright \xA9 2022 National Institute of Urban Affairs"), /*#__PURE__*/React__default.createElement("span", {
    style: {
      margin: "0 10px"
    }
...
var EmployeeApp = function EmployeeApp(_ref) {
  ...
  return /*#__PURE__*/React__default.createElement("div", {
    ...
    href: pdfUrl,
    target: "_blank"
  }, "UPYOG License"))))), /*#__PURE__*/React__default.createElement(reactRouterDom.Route, null, /*#__PURE__*/React__default.createElement(reactRouterDom.Redirect, {
    to: path + "/user/language-selection"
  }))));
};
...
var LocationSelection = function LocationSelection() {
  ...
  })), showError ? /*#__PURE__*/React__default.createElement(digitUiReactComponents.CardLabelError, null, t("LOCATION ERRROR")) : null));
};
