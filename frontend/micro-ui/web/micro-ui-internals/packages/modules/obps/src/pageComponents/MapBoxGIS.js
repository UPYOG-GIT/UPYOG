...
const MapBoxGIS = () => {
  ...
  // const [mapboxAccessToken] = useState("pk.eyJ1IjoiYmh1cGVzaGVudGl0IiwiYSI6ImNtM3IxeGY0djAxNDkybHI3NGlyOHZka3MifQ.DJ44H3NxwKpu6cy5UZ06AA");
    ...
    <div style={{ position: "relative", width: "100vw", height: "100vh" }}>
      <div style={{ position: "absolute", top: 10, left: 10, zIndex: 1 }}>
        <form onSubmit={handleSearchSubmit}>
          <input type="text" value={searchQuery} onChange={handleSearchChange} placeholder="Enter place name or Latitude, Longitude" />
