...
//				}
				...
				grossAmount.add(paymentDetails.get(0).getTotalAmountPaid());
				threeColTable2
						.addCell(new Cell().add(String.valueOf(srNo++)).setTextAlignment(TextAlignment.CENTER));
				threeColTable2.addCell(new Cell().add("Trip Amount"))
						.setTextAlignment(TextAlignment.CENTER);
				threeColTable2.addCell(new Cell().add(String.valueOf(paymentDetails.get(0).getTotalAmountPaid()))
						.setTextAlignment(TextAlignment.RIGHT));
