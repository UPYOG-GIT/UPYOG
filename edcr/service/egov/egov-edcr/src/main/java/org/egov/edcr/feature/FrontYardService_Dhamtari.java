...
@Service
public class FrontYardService_Dhamtari extends FrontYardService {

	private static final Logger LOG = LogManager.getLogger(FrontYardService_Dhamtari.class);
...
//					&& pl.getPlanInformation().getRoadWidth().compareTo(ROAD_WIDTH_TWELVE_POINTTWO) < 0
				...
				valid = residential(blockName, level, min, mean, mostRestrictiveOccupancy, frontYardResult, valid,
						subRule, rule, minVal, meanVal, depthOfPlot, widthOfPlot, errors, pl);
			}
