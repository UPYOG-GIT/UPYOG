...
@Service
public class FrontYardService_BhilaiCharoda extends FrontYardService {
...
//	private static final String RULE_37_TWO_I = "37-2-I";
	...
	private static final BigDecimal FRONTYARDMINIMUM_DISTANCE_3_2 = BigDecimal.valueOf(3.2);
	...
	private static final BigDecimal FRONTYARDMINIMUM_DISTANCE_21 = BigDecimal.valueOf(21);
	private static final BigDecimal FRONTYARDMINIMUM_DISTANCE_24 = BigDecimal.valueOf(24);
	...
	public void processFrontYard(Plan pl) {
		...
		LOG.info("inside FrontYardService_BhilaiCharoda processFrontYard()");
...
//					&& pl.getPlanInformation().getRoadWidth().compareTo(ROAD_WIDTH_TWELVE_POINTTWO) < 0
				...
				valid = commercial(level, blockName, min, mean, mostRestrictiveOccupancy, frontYardResult, valid,
						DxfFileConstants.RULE_28, rule, minVal, meanVal, depthOfPlot, buildingHeight, roadWidth);
			} else {
				valid = residential(blockName, level, min, mean, mostRestrictiveOccupancy, frontYardResult, valid,
						subRule, rule, minVal, meanVal, depthOfPlot, errors, pl, buildingHeight, roadWidth);
			}
			...
			valid = commercial(level, blockName, min, mean, mostRestrictiveOccupancy, frontYardResult, valid, subRule,
					rule, minVal, meanVal, depthOfPlot, buildingHeight, roadWidth);
		}
		return valid;
	}
