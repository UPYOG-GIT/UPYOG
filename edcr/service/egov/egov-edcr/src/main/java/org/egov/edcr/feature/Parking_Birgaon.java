...
@Service
public class Parking_Birgaon extends FeatureProcess {

	private static final Logger LOGGER = LogManager.getLogger(Parking_Birgaon.class);
...
//						.map(Measurement::getArea).reduce(BigDecimal.ZERO, BigDecimal::add));
				...
				if (occupancyTypeHelper == null || (occupancyTypeHelper != null
					...
					requiredCarParkArea += getRequiredCarParkArea(builupArea, occupancyTypeHelper, coverParkingArea,
...
//			setReportOutputParkingDetails(pl,"Open Parking",openParkingArea);
//			setReportOutputParkingDetails(pl,"Stilt Parking",stiltParkingArea);
//			setReportOutputParkingDetails(pl,"Lower Ground Floor Parking",lowerGroungFloorParkingArea);
//			setReportOutputParkingDetails(pl,"Basement Parking",basementParkingArea);
