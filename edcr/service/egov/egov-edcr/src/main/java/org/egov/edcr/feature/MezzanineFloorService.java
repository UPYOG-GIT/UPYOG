...
//	private static final String RULE46_MAXAREA_DESC = "Maximum allowed area of mezzanine floor";
	private static final String RULE46_MAXAREA_DESC = "Area of mezzanine floor";
//	private static final String RULE46_MINAREA_DESC = "Minimum area of mezzanine floor";
	private static final String RULE46_MINAREA_DESC = "Area of mezzanine floor";
//	private static final String RULE46_DIM_DESC = "Minimum height of mezzanine floor";
	private static final String RULE46_DIM_DESC = "Height of mezzanine floor";
...
//								else if (height.compareTo(HEIGHT_2_POINT_2) >= 0) {
								 ...
								 * mezzanineFloor.getMezzanineNumber(), floorNo, AREA_9_POINT_5 + SQMTRS,
								 * mezzanineFloor.getBuiltUpArea() + SQMTRS, Result.Accepted.getResultVal()); }
								 * else { setReportOutputDetails(pl, subRule, RULE46_MINAREA_DESC + " " +
								 * mezzanineFloor.getMezzanineNumber(), floorNo, AREA_9_POINT_5 + SQMTRS,
								 * mezzanineFloor.getBuiltUpArea() + SQMTRS,
...
//                                if (valid) {
								 ...
								 * mezzanineFloorArea + SQMTRS, Result.Not_Accepted.getResultVal()); }
								 */
							}
						}
					}
