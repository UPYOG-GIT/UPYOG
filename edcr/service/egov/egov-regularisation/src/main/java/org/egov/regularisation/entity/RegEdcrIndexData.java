...
public class RegEdcrIndexData {
	...
	public RegEdcrIndexData(RegApplicationType regApplicationType, String applicationNumber, Date applicationDate, String status,
	...
	public String toString() {
		return "EdcrIndexData [applicationType=" + regApplicationType + ", applicationNumber=" + applicationNumber
