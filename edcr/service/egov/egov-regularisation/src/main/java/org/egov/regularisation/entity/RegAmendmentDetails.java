 ...
 *
 */
public class RegAmendmentDetails implements Comparable<RegAmendmentDetails> {
	private String code;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		RegAmendmentDetails other = (RegAmendmentDetails) obj;
		if (dateOfBylaw == null) {
	...
	@Override
	public int compareTo(RegAmendmentDetails o) {
		if(o==null)
			return -1;
