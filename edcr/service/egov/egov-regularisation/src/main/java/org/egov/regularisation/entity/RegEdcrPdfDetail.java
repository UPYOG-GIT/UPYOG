...
@Entity
@Table(name = "EDCR_REG_PDF_DETAIL")
@SequenceGenerator(name = RegEdcrPdfDetail.SEQ_EDCR_PDF_DETAIL, sequenceName = RegEdcrPdfDetail.SEQ_EDCR_PDF_DETAIL, allocationSize = 1)
public class RegEdcrPdfDetail extends AbstractAuditable {

    public static final String SEQ_EDCR_PDF_DETAIL = "SEQ_EDCR_REG_PDF_DETAIL";
    ...
    private RegEdcrApplicationDetail regEdcrApplicationDetail;
    ...
    public RegEdcrApplicationDetail getEdcrApplicationDetail() {
        return regEdcrApplicationDetail;
    }

    public void setEdcrApplicationDetail(RegEdcrApplicationDetail regEdcrApplicationDetail) {
        this.regEdcrApplicationDetail = regEdcrApplicationDetail;
    }
