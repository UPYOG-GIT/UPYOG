...
@Entity
@Table(name = "EDCR_REG_APPLICATION")
@SequenceGenerator(name = RegEdcrApplication.SEQ_EDCR_APPLICATION, sequenceName = RegEdcrApplication.SEQ_EDCR_APPLICATION, allocationSize = 1)
public class RegEdcrApplication extends AbstractAuditable {
    /*
     * Application number and date.Owner name, contact info,email id, address, Architect name, emailid,contract info.
     */
    public static final String SEQ_EDCR_APPLICATION = "SEQ_EDCR_REG_APPLICATION";
    ...
    private RegApplicationType regApplicationType;
    ...
    @OrderBy("id DESC ")
    private List<RegEdcrApplicationDetail> regEdcrApplicationDetails;
    ...
    private transient RegEdcrApplicationDetail savedEdcrApplicationDetail;
...
//    private transient String areaCategory;
    ...
    public RegApplicationType getApplicationType() {
        return regApplicationType;
    }

    public void setApplicationType(RegApplicationType regApplicationType) {
        this.regApplicationType = regApplicationType;
    }
    ...
    public List<RegEdcrApplicationDetail> getEdcrApplicationDetails() {
        return regEdcrApplicationDetails;
    }

    public void setEdcrApplicationDetails(List<RegEdcrApplicationDetail> regEdcrApplicationDetails) {
        this.regEdcrApplicationDetails = regEdcrApplicationDetails;
    }
    ...
    public RegEdcrApplicationDetail getSavedEdcrApplicationDetail() {
        return savedEdcrApplicationDetail;
    }

    public void setSavedEdcrApplicationDetail(RegEdcrApplicationDetail savedEdcrApplicationDetail) {
