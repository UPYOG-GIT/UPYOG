...
@Service
public class RegParking_Birgaon extends FeatureProcess {

	private static final Logger LOGGER = LogManager.getLogger(RegParking_Birgaon.class);
...
//				)
				...
				if (requiredCarParkArea > 0 && totalProvidedCarParkingArea.compareTo(requiredCarParkingArea) < 0) {
