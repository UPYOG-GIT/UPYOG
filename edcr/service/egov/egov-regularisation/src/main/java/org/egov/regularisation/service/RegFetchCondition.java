...
public class RegFetchCondition extends ConditionStyleExpression implements CustomExpression {
    
    private static Logger LOG = LoggerFactory.getLogger(RegFetchCondition.class);

    private static final long serialVersionUID = 1L;
    private String fieldName;
    private String colorValue;

    public RegFetchCondition(String fieldName, String colorValue) {
