...
public class PlanInformation implements Serializable {
	...
	// Extracted from Plan info. Whether plot present in CRZ zone. Expecting default
	// value as NO.
	...
	// YES/NO/NA.Extracted from Plan info. Is building of type government or aided
	// school.
	...
	// Extracted from Plan info. In case of medical occupancy, capture number of
	// beds present in the building. Sanitation details are decided based on number
	// of beds present.
	...
	// YES/NO/NA.Extracted from Plan info.Is plan belongs to single family building.
	// There are few rules relaxed for single family building
	...
	// Extracted from Plan info. Land Use zone. The value should be standard like
	// RESIDENTIAL,COMMERCIAL,INDUSTRIAL,PUBLICANDSEMIPUBLIC etc.
	...
	// YES/NO/NA.Extracted from Plan info. Building near monument and permitted with
	// NOC
	private transient String nocNearMonument = NA;
	// YES/NO/NA.Extracted from Plan info. Building near airport and permitted with
	// airport authority
	private transient String nocNearAirport = NA;
	// YES/NO/NA.Extracted from Plan info. Building near defence aerodrome and
	// permitted with NOC
	private transient String nocNearDefenceAerodomes = NA;
	// YES/NO/NA.Extracted from Plan info. Permitted with state Environmental impact
	...
	// YES/NO/NA.Extracted from Plan info. Permitted with noc issued by collector on
	// govt. land
	...
	// YES/NO/NA.Extracted from Plan info. Barrier free access for physically
	// handicapped person provided.
	private transient String barrierFreeAccessForPhyChlngdPpl = NA;
	// YES/NO/NA.Extracted from Plan info. Provision for green building and
	// sustainability provided in plan.Rainwater harvesting,solar,segregation of
	// waste etc.
	private transient String provisionsForGreenBuildingsAndSustainability = NA;
	// YES/NO/NA.Extracted from Plan info. Fire Protection And Fire Safety
	// Requirements declared in the plan.
...
//
//	private transient BigDecimal netPlotArea;
	 ...
	 * setNocToAbutSide(Boolean nocToAbutSide) { this.nocToAbutSide = nocToAbutSide;
	 * }
	 */
	/*
	 * public Boolean getNocToAbutRear() { return nocToAbutRear; } public void
	 * setNocToAbutRear(Boolean nocToAbutRear) { this.nocToAbutRear = nocToAbutRear;
	 * }
	 */
	...
	/*
	 * public Boolean getNocToAbutAdjascentSide() { return nocToAbutAdjascentSide; }
