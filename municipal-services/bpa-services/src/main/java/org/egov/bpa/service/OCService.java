...
public class OCService {
	 ...
	 * @param criteria
	 */
	private void extractEdcrData(ArrayList<LinkedHashMap<String, Object>> edcrData, ArrayList<String> riskType,
			ArrayList<String> khathaNos, ArrayList<String> plotNos, ArrayList<String> occupancy,
		...
		edcrData.forEach(edcrDetail -> {
			...
			Double buildingHeight = (Double) ((List) JsonPath.read(edcrDetail,
