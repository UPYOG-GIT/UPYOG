...
public class LandInfo {
	...
	/**
	 * Unique Identifier of the Land in municipal departmrnt (eg. registration no,
	 * survey no etc).
	 * 
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.id, landInfo.id) && Objects.equals(this.landUId, landInfo.landUId)
				&& Objects.equals(this.landUniqueRegNo, landInfo.landUniqueRegNo)
				&& Objects.equals(this.tenantId, landInfo.tenantId) && Objects.equals(this.status, landInfo.status)
				...
				&& Objects.equals(this.source, landInfo.source) && Objects.equals(this.channel, landInfo.channel)
				&& Objects.equals(this.documents, landInfo.documents) && Objects.equals(this.unit, landInfo.unit)
	...
	@Override
	public int hashCode() {
		return Objects.hash(id, landUId, landUniqueRegNo, tenantId, status, address, ownershipCategory, owners,
				institution, source, channel, documents, unit, additionalDetails, auditDetails);
	}
	...
	public Double getPlotAreaApproved() {
		return plotAreaApproved;
	}
