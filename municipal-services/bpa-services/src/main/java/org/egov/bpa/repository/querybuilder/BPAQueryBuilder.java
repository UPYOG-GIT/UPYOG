...
public class BPAQueryBuilder {
	...
	private static final String QUERY = "SELECT bpa.*,bpadoc.*,bpa.id as bpa_id,bpa.tenantid as bpa_tenantId,bpa.lastModifiedTime as "
			...
			+ "bpa_createdTime,bpa.additionalDetails,bpa.swsdetails,bpa.landId as bpa_landId, bpadoc.id as bpa_doc_id, bpadoc.additionalDetails as doc_details, bpadoc.documenttype as bpa_doc_documenttype,bpadoc.filestoreid as bpa_doc_filestore"
	...
	private static final String QUERY1 = "SELECT" + " bp.id as bpa_id, billdetail.consumercode as applicationno," + "  bp.tenantid as bpa_tenantId,"
			+ "  bp.createdtime AS applicationdate, bp.landId as bpa_landId, bp.createdby,"
	...
	public String getBPASearchQuery(BPASearchCriteria criteria, List<Object> preparedStmtList, List<String> edcrNos,
		...
		if (applicationType != null) {
			...
			addClauseIfRequired(preparedStmtList, builder);
			builder.append(" bpa.additionaldetails ->>'applicationType' IN (").append(createQuery(applicationTypes))
					.append(")");
		...
		if (serviceType != null) {
			...
			addClauseIfRequired(preparedStmtList, builder);
			builder.append(" bpa.additionaldetails ->>'serviceType' IN (").append(createQuery(serviceTypes))
					.append(")");
		...
		if (pemritNumber != null) {
			...
			addClauseIfRequired(preparedStmtList, builder);
			builder.append(" bpa.additionaldetails ->>'permitNumber' IN (").append(createQuery(pemritNumbers))
					.append(")");
	...
	public String getApplicationSearchQuery(BPASearchCriteria criteria, List<Object> preparedStmtList) {

		StringBuilder builder = new StringBuilder(QUERY1);
