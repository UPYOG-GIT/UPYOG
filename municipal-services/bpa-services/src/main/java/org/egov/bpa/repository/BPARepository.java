...
//				+ "where ulb_tenantid=? AND paytype_id=?";
	...
	public List<Map<String, Object>> getDataCountsForDashboard(String tenantId) {
		String query1 = "SELECT\n"
			    ...
			    + "        SUM(CASE WHEN bp.status IN ('DOC_VERIFICATION_INPROGRESS_BY_ENGINEER', 'DOC_VERIFICATION_INPROGRESS_BY_BUILDER', 'POST_FEE_APPROVAL_INPROGRESS') THEN 1 ELSE 0 END) AS department_inprocess\n"	
