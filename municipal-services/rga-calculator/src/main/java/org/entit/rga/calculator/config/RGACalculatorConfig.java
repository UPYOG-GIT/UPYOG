package org.entit.rga.calculator.config;
...
@Configuration
@Data
public class RGACalculatorConfig {
    ...
    private String rgaHost;

    @Value("${egov.rga.context.path}")
    private String rgaContextPath;

    @Value("${egov.rga.create.endpoint}")
    private String rgaCreateEndpoint;

    @Value("${egov.rga.update.endpoint}")
    private String rgaUpdateEndpoint;

    @Value("${egov.rga.search.endpoint}")
    private String rgaSearchEndpoint;
...
//    Kafka Topics
    @Value("${persister.save.rga.calculation.topic}")
