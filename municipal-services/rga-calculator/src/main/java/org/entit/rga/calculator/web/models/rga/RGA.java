...
import org.entit.rga.calculator.web.models.Document;
import org.entit.rga.calculator.web.models.landinfo.LandInfo;
import org.entit.rga.calculator.web.models.landinfo.Workflow;
...
/**
 * RGA application object to capture the details of land, land owners, and address of the land.
 */
@ApiModel(description = "RGA application object to capture the details of land, land owners, and address of the land.")
@Validated
...
public class RGA   {
  ...
  public RGA id(String id) {
    this.id = id;
    return this;
  }

  /**
   * Unique Identifier(UUID) of the rga application for internal reference.
   * @return id
  **/
  @ApiModelProperty(readOnly = true, value = "Unique Identifier(UUID) of the rga application for internal reference.")
  ...
  public RGA applicationNo(String applicationNo) {
  ...
  **/
  ...
  public RGA approvalNo(String approvalNo) {
  ...
  **/
  ...
  public RGA accountId(String accountId) {
  ...
  **/
  ...
  public RGA edcrNumber(String edcrNumber) {
  ...
  **/
  ...
  public RGA riskType(String riskType) {
  ...
  **/
  ...
  public RGA approvalDate(Long approvalDate) {
  ...
  **/
  ...
  public RGA applicationDate(Long applicationDate) {
  ...
  public RGA businessService(String businessService) {
  ...
  public RGA landId(String landId) {
    this.landId = landId;
    return this;
  }
  ...
  **/
  ...
  public RGA tenantId(String tenantId) {
  ...
  **/
  ...
  public RGA status(String status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public RGA documents(List<Document> documents) {
    this.documents = documents;
    return this;
  }

  public RGA addDocumentsItem(Document documentsItem) {
  ...
  **/
  ...
  public RGA landInfo(LandInfo landInfo) {
  ...
  **/
  ...
  public RGA workflow(Workflow workflow) {
  ...
  **/
  ...
  public RGA auditDetails(AuditDetails auditDetails) {
  ...
  **/
  ...
  public RGA additionalDetails(Object additionalDetails) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    RGA RGA = (RGA) o;
    return Objects.equals(this.id, RGA.id) &&
        Objects.equals(this.applicationNo, RGA.applicationNo) &&
        Objects.equals(this.approvalNo, RGA.approvalNo) &&
        Objects.equals(this.accountId, RGA.accountId) &&
        Objects.equals(this.edcrNumber, RGA.edcrNumber) &&
        Objects.equals(this.riskType, RGA.riskType) &&
        Objects.equals(this.landId, RGA.landId) &&
        Objects.equals(this.tenantId, RGA.tenantId) &&
        Objects.equals(this.status, RGA.status) &&
        Objects.equals(this.documents, RGA.documents) &&
        Objects.equals(this.landInfo, RGA.landInfo) &&
        Objects.equals(this.workflow, RGA.workflow) &&
        Objects.equals(this.auditDetails, RGA.auditDetails) &&
        Objects.equals(this.additionalDetails, RGA.additionalDetails);
  }
