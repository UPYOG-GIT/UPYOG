...
public class RGAConfiguration {
	...
	@Value("${egov.idgen.rga.applicationNum.name}")
	private String applicationNoIdgenName;

	@Value("${egov.idgen.rga.applicationNum.format}")
	private String applicationNoIdgenFormat;

	@Value("${egov.idgen.rga.permitNum.name}")
	private String permitNoIdgenName;

	@Value("${egov.idgen.rga.permitNum.format}")
	...
	@Value("${egov.rga.default.limit}")
	private Integer defaultLimit;

	@Value("${egov.rga.default.offset}")
	private Integer defaultOffset;

	@Value("${egov.rga.max.limit}")
	...
	// Calculator
	@Value("${egov.rga.calculator.host}")
	private String calculatorHost;

	@Value("${egov.rga.calculator.calculate.endpoint}")
	...
	// Workflow
	@Value("${create.rga.workflow.name}")
	private String businessServiceValue;

	@Value("${create.rga.low.workflow.name}")
